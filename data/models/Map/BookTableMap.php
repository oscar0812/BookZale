...
class BookTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Price', 'Description', 'ImageUrl', 'PostedBy', 'Sold', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'price', 'description', 'imageUrl', 'postedBy', 'sold', ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_NAME, BookTableMap::COL_PRICE, BookTableMap::COL_DESCRIPTION, BookTableMap::COL_IMAGE_URL, BookTableMap::COL_POSTED_BY, BookTableMap::COL_SOLD, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'price', 'description', 'image_url', 'posted_by', 'sold', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Price' => 2, 'Description' => 3, 'ImageUrl' => 4, 'PostedBy' => 5, 'Sold' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'price' => 2, 'description' => 3, 'imageUrl' => 4, 'postedBy' => 5, 'sold' => 6, ),
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_NAME => 1, BookTableMap::COL_PRICE => 2, BookTableMap::COL_DESCRIPTION => 3, BookTableMap::COL_IMAGE_URL => 4, BookTableMap::COL_POSTED_BY => 5, BookTableMap::COL_SOLD => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'price' => 2, 'description' => 3, 'image_url' => 4, 'posted_by' => 5, 'sold' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
