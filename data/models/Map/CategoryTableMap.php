...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_PARENT = 'category.parent';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Parent', 'Name', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'parent', 'name', 'description', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_PARENT, CategoryTableMap::COL_NAME, CategoryTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'parent', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Parent' => 1, 'Name' => 2, 'Description' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'parent' => 1, 'name' => 2, 'description' => 3, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_PARENT => 1, CategoryTableMap::COL_NAME => 2, CategoryTableMap::COL_DESCRIPTION => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'parent' => 1, 'name' => 2, 'description' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::COL_PARENT);
