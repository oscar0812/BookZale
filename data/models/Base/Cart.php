...
abstract class Cart implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartTableMap::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CartTableMap::COL_BOOK_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CartTableMap::COL_BOOK_ID)) {
            $criteria->add(CartTableMap::COL_BOOK_ID, $this->book_id);
        }
